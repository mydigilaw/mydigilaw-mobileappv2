...
public class Law_Copyright extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law__copyright);
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(Law_Copyright.this,First_Information_Form.class);
                startActivity(i);
            }
        });
