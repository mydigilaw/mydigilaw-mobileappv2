...
public class Law_Maintence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law__maintence);
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(Law_Maintence.this,First_Information_Form.class);
                startActivity(i);
            }
        });
