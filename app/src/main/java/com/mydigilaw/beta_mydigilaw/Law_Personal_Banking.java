...
public class Law_Personal_Banking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law__personal_banking);
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(Law_Personal_Banking.this,First_Information_Form.class);
                startActivity(i);
            }
        });
