...
public class Law_Labour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law__labour);
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(Law_Labour.this,First_Information_Form.class);
                startActivity(i);
            }
        });
