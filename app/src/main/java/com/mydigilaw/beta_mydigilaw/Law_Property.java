...
public class Law_Property extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law__property);
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(Law_Property.this,First_Information_Form.class);
                startActivity(i);
            }
        });
